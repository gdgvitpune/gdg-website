...
const SpaceLoader = ({ onComplete, duration = 3000 }: SpaceLoaderProps) => {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-black">
      <div className={`absolute inset-0 transition-opacity duration-700 ${fadeOut ? 'opacity-0' : 'opacity-100'}`}>
            ...
            <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
              <div className="mobile-loader w-11/12 max-w-sm mx-auto text-center">
                ...
                <div className="progress-track w-full h-3 bg-white/10 rounded-full overflow-hidden">
                  <div ref={progressRef} className="progress-fill h-full bg-gradient-to-r from-yellow-300 to-yellow-500 w-0" />
                </div>
      ...
      <style jsx>{`
        ...
        .mobile-stars {
          background-image: radial-gradient(rgba(255,255,255,0.18) 1px, transparent 1px), radial-gradient(rgba(255,255,255,0.12) 1px, transparent 1px);
